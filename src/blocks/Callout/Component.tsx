  ...
  return (
    <div style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto py-32 md:py-64 relative grid gap-16 md:gap-0 grid-cols-4 md:grid-cols-12 grid-flow-row md:grid-flow-col items-center">
        <div className="w-[50%] mx-auto col-span-full md:col-span-5 z-[1]">
          <RichText
            data={props.caption}
        ...
        <div className="flex flex-col col-span-full md:col-span-5 md:col-start-8 gap-16">
          <RichText
            ...
            className="font-sans text-base md:text-[1.312rem] text-white"
          />
          <div className="flex flex-col gap-5">
            {props.CTAs?.map((cta) => (
              ...
              >
                <RichText
                  data={cta.content!}
                  className="text-white w-fit text-[1.312rem] font-serif"
                />{' '}
                <ArrowRight className="text-white ml-4 text-sm" />
              </span>
            ))}
          </div>
        </div>
