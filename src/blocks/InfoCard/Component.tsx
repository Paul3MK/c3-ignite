  ...
  return (
    <div
      className={clsx('container mx-auto relative grid md:grid-flow-col  md:grid-cols-2', {
        ...
        'grid-cols-2 md:items-end': props.variant == 'fullWidth',
      })}
    ...
    >
      <div
        ...
        className={clsx(
          ...
          {
            'md:mt-16 md:pt-16 md:pl-16 md:pb-16 md:h-[400px]': props.variant == 'fullWidth',
      ...
      >
        <div
          className={clsx('md:max-w-[40%] flex flex-col gap-4 md:gap-0 md:h-auto', {
            'md:justify-between': props.variant == 'fullWidth',
      ...
      {props.cardImage && (
        <Media
          ...
          className={clsx('relative col-start-2 row-start-1 place-self-end', {
            'md:max-w-[60%]': props.variant == 'fullWidth',
          })}
        />
      )}
    </div>
